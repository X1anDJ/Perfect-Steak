...
#ifndef STEAKSCIENCE_SWIFT_H
#define STEAKSCIENCE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SteakScience",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12SteakScience11AppDelegate")
...
SWIFT_CLASS("_TtC12SteakScience9ArrowView")
...
SWIFT_CLASS_NAMED("CDSteakRecipe")
@interface CDSteakRecipe : NSManagedObject
...
@interface CDSteakRecipe (SWIFT_EXTENSION(SteakScience))
@property (nonatomic) double desiredCenterTemp;
@property (nonatomic, copy) NSUUID * _Nullable id;
@property (nonatomic) double initialTemp;
@property (nonatomic) double ovenTemp;
...
SWIFT_CLASS("_TtC12SteakScience14CircularSlider")
...
SWIFT_CLASS("_TtC12SteakScience13ConcaveButton")
...
SWIFT_CLASS("_TtC12SteakScience14DonenessSlider")
...
@class SteakTemperature;
@class NSString;
@class NSBundle;

SWIFT_CLASS("_TtC12SteakScience18MainViewController")
...
@interface MainViewController (SWIFT_EXTENSION(SteakScience)) <UIPopoverPresentationControllerDelegate>
...
SWIFT_CLASS("_TtC12SteakScience24OnboardingViewController")
...
@interface OnboardingViewController (SWIFT_EXTENSION(SteakScience)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC12SteakScience33RecipeDropdownTableViewController")
...
SWIFT_CLASS("_TtC12SteakScience19RecipeTableViewCell")
...
SWIFT_CLASS("_TtC12SteakScience9RulerView")
...
SWIFT_CLASS("_TtC12SteakScience19RulerViewController")
...
SWIFT_CLASS("_TtC12SteakScience13SceneDelegate")
...
SWIFT_CLASS("_TtC12SteakScience16SteakTemperature")
@interface SteakTemperature : UIView
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified parameterTitle;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified parameterNumber;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified parameterUnit;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified rangeBegin;
...
@interface UIView (SWIFT_EXTENSION(SteakScience))
