...
#ifndef PERFECTSTEAK_SWIFT_H
#define PERFECTSTEAK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PerfectSteak",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12PerfectSteak11AppDelegate")
...
SWIFT_CLASS("_TtC12PerfectSteak9ArrowView")
...
@interface CDSteakRecipe (SWIFT_EXTENSION(PerfectSteak))
...
SWIFT_CLASS("_TtC12PerfectSteak12HomeGideView")
@interface HomeGideView : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC12PerfectSteak13NumberPadView")
...
@interface OnboardingViewController (SWIFT_EXTENSION(PerfectSteak)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC12PerfectSteak19RulerViewController")
...
SWIFT_CLASS("_TtC12PerfectSteak13SceneDelegate")
...
SWIFT_CLASS("_TtC12PerfectSteak16SteakTemperature")
